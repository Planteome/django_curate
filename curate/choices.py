...
# gene object types, has overlap with annotation object types
class GeneType(models.IntegerChoices):
    lncRNA = 1, "lncRNA"
    non_coding = 2, "non_coding"
    ThreePrime_overlapping_ncRNA = 3, "3prime_overlapping_non_coding"
    antisense_RNA = 4, "antisense_RNA"
    lincRNA = 5, "lincRNA"
    retained_intron = 6, "retained_intron"
    sense_intronic = 7, "sense_intronic"
    sense_overlapping = 8, "sense_overlapping"
    macro_lncRNA = 9, "macro_lncRNA"
    bidirectional_lncRNA = 10, "bidirectional_lncRNA"
    ncRNA = 11, "ncRNA"
    miRNA = 12, "miRNA"
    piRNA = 13, "piRNA"
    rRNA = 14, "rRNA"
    ...
    snoRNA = 17, "snoRNA"
    tRNA = 18, "tRNA"
    vaultRNA = 19, "vaultRNA"
    pseudogene = 20, "pseudogene"
    protein_coding = 21, "protein_coding"
    tRNA_pseudogene = 22, "tRNA_pseudogene"
    nontranslating_CDS = 23, "nontranslating_CDS"
    pre_miRNA = 24, "pre_miRNA"
    SRP_RNA = 25, "SRP_RNA"
    RNase_MRP_RNA = 26, "RNase_MRP_RNA"
